...
namespace Modder_76561198100202539.EventConfig.Taiwu.EventGroupe44b04fbc55643ee8b0aa5c7f0c6178a
{
        ...
        public FirstModEvent_793b2f76e026475eb6b02b232343cb3c()
        {
            ...
            EventOptions = new TaiwuEventOption[]
            {
                new TaiwuEventOption
                    { OptionKey = "Option_1401059141", OptionGuid = "e08468c7-821d-42d9-b363-3eaac72a765c" }
            };
            InitOptions();
        }
    ...
    #region EventAPI
        ...
        {
            return $"不知斗了几轮日月，人群间唯闻金铁交鸣之声。待得最后一声虫嘶裂空，青石台上横七竖八躺着败将。\n" +
                   "太吾"+"那几只无名小虫虽遍体鳞伤却昂首振翅，甲壳尽裂处，竟带三分寒芒。\n";
        }
