...
{
	public class FirstModEvent_ed82f1ad7c544dcba5f20e454aa409bc : TaiwuEventItem
	{
		public FirstModEvent_ed82f1ad7c544dcba5f20e454aa409bc()
		{
			//事件GUID
			Guid = Guid.Parse("ed82f1ad-7c54-4dcb-a5f2-0e454aa409bc");
			//该事件是否是头部事件
			IsHeadEvent = false;
			//事件分组
			...
			{
				new TaiwuEventOption{ OptionKey = "Option_1925013918", OptionGuid = "643d7f09-de6b-4c48-b907-7a77e7172711"}
			};
			InitOptions();
		}
		...
		{
			return "广袖翻动间抖出几只粗陶罐，正要往青石擂台上搁，忽被白发老丈枯手一横拦住。\n " +
			       "老者耳尖微动：\"这罐中虫吟虚浮，连三叠浪的筋骨都未成。\" \n " +
			       "烟杆轻敲陶罐，惊起几声散乱鸣叫，\"待你寻得能振碎瓦当的虫儿，我等自当奉陪。\" \n" +
			       " 围观人群闻言纷纷摇头，渐渐散去。";
		}
